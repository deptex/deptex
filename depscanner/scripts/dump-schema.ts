 ...
 * Run: `npm run schema:dump` (from depscanner/).
 *
...
const OUT_FILE = path.resolve(__dirname, '../../backend/database/schema.sql');
...
async function main() {
  ...
  out.push('-- Generated by depscanner/scripts/dump-schema.ts');
