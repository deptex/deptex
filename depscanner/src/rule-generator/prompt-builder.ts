...
export function buildGenerationPrompt(args: BuildPromptArgs): string {
  ...
  return [
    ...
    `  - Declaring \`Class.method(*)\` when fixture uses lowercase-instance form: pick either an instance form like \`*.method(*)\` (wildcard receiver) OR ensure the fixture itself spells the class identifier verbatim.`,
