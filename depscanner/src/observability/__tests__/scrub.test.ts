...
// Smoke test for the depscanner copy of the canonical backend scrubber.
// Full coverage lives in backend/src/lib/observability/__tests__/scrub.test.ts;
// this proves the copy is present + wired in the depscanner package.
describe('depscanner scrub (copy of backend canonical)', () => {
