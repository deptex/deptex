...
export const PLAN_LIMITS: Record<string, { maxProjects?: number; maxMembers?: number }> = {
  free: {},
  pro: {},
  team: {},
  enterprise: {},
...
export async function invalidatePlanCache(_organizationId: string): Promise<void> {
  // Optional: invalidate Redis/cache when plan changes
}
