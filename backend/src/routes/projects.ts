...
// AI-powered security fixing now lives at /api/aegis/fix (see routes/aegis-fix.ts).
// The legacy aider-direct endpoints were retired alongside the aider-worker.
