...
// ============================================================
// Phase 7B+: tasks, automations, memory, settings, sprints, etc.
...
// The legacy aegis-v2 task + approval endpoints were removed with the v2 task
// primitive. The new Aegis Task lives at /api/aegis/tasks (routes/aegis-tasks.ts).
...
// The legacy aegis-v2 sprint-orchestration endpoints were removed with the v2
// task primitive. Security-debt scoring (below) is unaffected.
