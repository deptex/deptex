...
import aegisAutomationsRouter from './routes/aegis-automations';
...
import silenceDriftCronRouter from './routes/silence-drift-cron';
...
import aegisTasksRouter from './routes/aegis-tasks';
...
app.use('/api/internal/aegis', aegisAutomationsRouter);
...
app.use('/api/internal/silence', silenceDriftCronRouter);
...
app.use('/api/aegis/tasks', aegisTasksRouter); // before /api/aegis so it isn't shadowed
