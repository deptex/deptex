...
function SkeletonProjectCenterNodeComponent(_props: NodeProps) {
  return (
    <div className="relative">
      ...
      <div
        className="relative rounded-xl border-2 shadow-lg overflow-hidden min-w-[260px] border-border shadow-zinc-500/10 bg-background-card px-5 pt-4 pb-4"
      >
        <div className="absolute inset-0 rounded-xl blur-xl opacity-20 -z-10 bg-muted" />
        <div className="flex items-center gap-2.5">
          <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-muted animate-pulse" />
