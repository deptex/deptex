...
// Smoke test for the frontend copy of the canonical backend scrubber.
// Full coverage lives in backend/src/lib/observability/__tests__/scrub.test.ts;
// this proves the copy is present + wired in the frontend package.
describe('frontend scrub (copy of backend canonical)', () => {
