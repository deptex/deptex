  ...
  return (
    <div className="space-y-12">
      ...
      <div>
        ...
        <div className="space-y-3 text-foreground/90 leading-relaxed">
          <p>
            Each project carries a numeric <strong className="text-foreground">importance</strong> in <code className="rounded bg-background-subtle px-1.5 py-0.5 text-xs font-mono">[0.5, 2.0]</code> (default <code className="rounded bg-background-subtle px-1.5 py-0.5 text-xs font-mono">1.0</code>). The number IS the Depscore multiplier — set it higher for critical systems, lower for non-production / sandbox. Edit it on the project Settings page.
          </p>
          <p>
            Every call to <code className="rounded bg-background-subtle px-1.5 py-0.5 text-xs font-mono">packagePolicy</code> and <code className="rounded bg-background-subtle px-1.5 py-0.5 text-xs font-mono">projectStatus</code> receives <code className="rounded bg-background-subtle px-1.5 py-0.5 text-xs font-mono">context.importance</code> (and the same value on <code className="rounded bg-background-subtle px-1.5 py-0.5 text-xs font-mono">context.project.importance</code>), so you can write stricter rules for high-importance projects. See <Link to="/docs/organizations" className="text-foreground underline hover:no-underline">Organizations</Link> for where importance is set.
          </p>
        </div>
      </div>
