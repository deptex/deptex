...
import { PreflightSidebar, ALL_ECOSYSTEMS, getEcosystemIcon } from '../../components/PreflightSidebar';
            ...
            <div className="space-y-8">
              {isInitialExtracting ? (
                ...
                <ExtractionProgressCard
                  ...
                  description="Compliance data will not be available until extraction succeeds."
                  showLogsToggle
                  organizationId={organizationId}
                  projectId={projectId}
                  onRetry={async () => {
