...
import { FolderGit2, Book, ChevronLeft, ChevronRight } from "lucide-react";

const features = [
  {
    title: "Branch Tracking",
    description: "Auto-track branches with commits in the last 30 days. Monitor main and feature branches for dependency changes and vulnerabilities.",
  },
  {
    title: "Dependency Graph",
    description: "Visualize direct and transitive dependencies in a tree view. See version, license, vulnerabilities, and maintainer health for each package.",
  },
  {
    title: "GitHub Integration",
    description: "Seamless GitHub App integration for repo linking, dependency graph fetching, and automatic SBOM generation from your lockfiles.",
  },
  {
    title: "Multi-Ecosystem Support",
    description: "Support for npm, pip, Maven, Go modules, and more. Parse lockfiles automatically to build comprehensive dependency graphs.",
  },
];

export default function RepositoryTrackingPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-lg font-medium text-foreground-secondary">Repository Tracking</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-foreground">
                Repository Tracking
              </h1>
              <p className="text-xl text-foreground-secondary mb-8 leading-relaxed">
                Deep dependency tracking with support for direct and transitive dependencies. Monitor branch presence, track version changes, and get real-time alerts when your supply chain is affected.
              </p>
