...
import { FileCheck, Book, ChevronLeft, ChevronRight } from "lucide-react";

const features = [
  {
    title: "SBOM Generation",
    description: "Generate comprehensive SBOMs in standard formats: SPDX and CycloneDX JSON. Export on-demand or schedule automatic generation for releases.",
  },
  {
    title: "Policy Enforcement",
    description: "Define org-wide and project-level policies for licenses, vulnerability thresholds, and source policies. Enforce compliance automatically with blocking PR checks.",
  },
  {
    title: "SBOM Cross-Checker",
    description: "Compare declared SBOM vs runtime SBOM and alert on divergence. Detect unexpected runtime packages that weren't in your declared dependencies.",
  },
];

export default function SBOMCompliancePage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-lg font-medium text-foreground-secondary">SBOM & Compliance</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-foreground">
                SBOM & Compliance
              </h1>
              <p className="text-xl text-foreground-secondary mb-8 leading-relaxed">
                Generate comprehensive Software Bill of Materials (SBOM) and track compliance across your organization. Export in standard formats, compare declared vs runtime SBOMs, and track policy violations in real-time.
              </p>
