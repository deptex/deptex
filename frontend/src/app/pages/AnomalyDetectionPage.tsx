...
import { Eye, Book, ChevronLeft, ChevronRight } from "lucide-react";

const features = [
  {
    title: "Commit Anomaly Detection",
    description: "Monitor upstream commits for suspicious patterns. Detect unexpected changes, unusual commit frequencies, or signs of account compromise.",
  },
  {
    title: "Typosquat Detection",
    description: "Identify packages with name-similarity to popular packages. Flag potential typosquatting attacks before they impact your projects.",
  },
  {
    title: "Malicious Package Detection",
    description: "Detect packages with suspicious install scripts, small ownership indicators, or recently created maintainer accounts that may indicate malicious intent.",
  },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-lg font-medium text-foreground-secondary">Anomaly Detection</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-foreground">
                Anomaly Detection
              </h1>
              <p className="text-xl text-foreground-secondary mb-8 leading-relaxed">
                Our AI-powered anomaly detection monitors package behavior, commit patterns, and dependency changes to flag potential security risks in real-time.
              </p>
