...
| **r6 confirmation** | _(in progress)_ | `bench-iterate/seeded-42-r6-temp0/`. Same config as r5 (seed=42 + temp=0 + prompt-v2). If r6 ≈ 55: stable. If r6 swings >±3, temp=0 not fully deterministic and the +6pp is partly luck. |
