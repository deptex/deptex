...
| **seed=42 r4 (prompt v2)** | _(in progress)_ | `bench-iterate/seeded-42-r4-promptfix/`. ETA ~50 min. Measures whether the prompt fix actually claims a chunk of the 22 fixture_pre_match=false stable misses. Single-trial measurement still noisy ±3pp; treat ≥+5pp as real, smaller as inconclusive pending multi-trial. |
